import { Check, Music, Play, Pause, SkipForward, SkipBack, Square } from 'lucide-react'
import {
  Command,
  CommandEmpty,
  CommandGroup,
                  ...
                  return (
                    ...
                    >
                      <Check
                        className={cn(
                          'mr-2 h-4 w-4',
                          value === song.id.toString() ? 'opacity-100' : 'opacity-0',
                        )}
                      />
                  ...
                  return (
                    ...
                    >
                      <Check
                        className={cn(
                          'mr-2 h-4 w-4',
                          value === playlist.id.toString() ? 'opacity-100' : 'opacity-0',
                        )}
                      />
